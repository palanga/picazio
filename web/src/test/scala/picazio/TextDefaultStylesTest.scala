...
//      html <- select.renderedHtml
//    } yield html shouldBe """<input placeholder="hola..." style="padding-top: 4px; padding-bottom: 0px;">"""
//  }
//
...
//      html <- select.renderedHtml
//    } yield html shouldBe """<button style="padding-top: 3px; padding-bottom: 1px; cursor: pointer;">HOLA</button>"""
//  }
//
...
//      html <- select.renderedHtml
//    } yield html shouldBe """<div style="display: flex; flex-direction: row; align-items: flex-start; justify-content: flex-start;"><span style="padding-top: 4px;">hola</span><input placeholder="hola..." style="padding-top: 4px; padding-bottom: 0px;"><button style="padding-top: 3px; padding-bottom: 1px; cursor: pointer;">HOLA</button></div>"""
//  }
